...
class PropertySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $property_type = new \App\Models\Attributes([
            'name'=>'Property Type',
            'service'=>'property'
        ]);
        ...
        foreach ($IDs as $property_id){
            foreach ($term_ids as $k=>$term_id) {
                ...
                \App\Models\PropertyTerm::firstOrCreate([
                    'term_id' => $term_id,
        ...
        foreach ($IDs as $service_id){
            \App\Models\Property::find($service_id)->update_service_rate();
        }
    }
}
