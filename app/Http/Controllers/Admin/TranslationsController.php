...
class TranslationsController extends AdminController
{
    ...
    public function detail(Request $request, $id)
    {
        ...
        $origins = $query->orderBy('translations.string', 'asc')->paginate(30);
    ...
    public function build($id)
    {
        ...
        $query = Translation::select([
            'translations.*',
            't.string as origin'
        ])->where('translations.locale', $lang->locale)->whereRaw("IFNULL(translations.string,'') != '' ");
