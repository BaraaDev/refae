<?php
    ...
    use App\Models\AgenciesAgent;
    use App\Models\Booking;
    use App\Models\Review;
    // use App\Emails\EmailUserVerifyRegister;
    use App\Emails\ResetPasswordToken;
...
//        }
        ...
        {
            return $this->hasMany('App\Models\Property', 'create_user', 'id')->where('properties.status', '=', 'publish');
        }
        ...
        public function sendEmailVerificationNotification(){
            $this->notify(new \App\Models\User\Emails\VerifyEmailNotification());
        }
        ...
        //     return $this->hasManyThrough('App\Models\PropertyCategory', 'App\Models\Property', 'category_id', 'id', 'id', 'create_user');
        // }
        ...
        {
            return $this->hasOne(AgenciesAgent::class, 'agent_id');
        }
