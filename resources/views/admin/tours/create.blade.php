...
@section('content')
    ...
    <form action="{{route('dashboard.tours.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"> Add new Tour</h1>
                </div>
            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"  placeholder="{{__("Name of the Tour")}}" name="title" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"   placeholder="{{__("Example: 3")}}" name="days" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control" placeholder="{{__("Real address")}}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" min="0" name="price" class="form-control" placeholder="{{__("Tour Price")}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
