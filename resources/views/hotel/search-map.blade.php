...
@endsection
@section('content')
    <div class="bravo_search_tour bravo_search_property">
        <div class="bravo_form_search_map">
            @include('layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map">
            ...
            <div class="results_item">
                {{--  @include('layouts.search-map.advance-filter')  --}}
                <div class="listing_items">
                    {{--  @include('layouts.search-map.list-item')  --}}
                </div>
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script type="text/javascript" src="{{ asset('module/property/js/property-map.js?_ver='.config('app.version')) }}"></script>
@endsection
