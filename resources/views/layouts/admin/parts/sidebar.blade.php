...
<ul class="main-menu">
    ...
    <li class="has-children dashboard_news">
        ...
        <ul class="children">
                ...
                <li class="">
                    <a href="{{ route('dashboard.hotel.index') }}">   <i class="fa fa-dot-circle-o"></i>
                      {{ __('All Hotels') }}
                     </a>
                </li>

                <li class="">
                    <a href="{{ route('dashboard.hotel.create') }}">   <i class="fa fa-dot-circle-o"></i>
                      {{ __("Add New Hotel") }}
                     </a>
                </li>
...
<li class="has-children dashboard_news">
    ...
    <ul class="children">
            ...
            <li class="">
                <a href="{{ route('dashboard.tours.index') }}">   <i class="fa fa-dot-circle-o"></i>
                  {{ __('All Tours') }}
                 </a>
            </li>

            <li class="">
                <a href="{{ route('dashboard.tours.create') }}">   <i class="fa fa-dot-circle-o"></i>
                  {{ __("Add New Tour") }}
                 </a>
            </li>
    ...
    <li class="has-children dashboard_news">
        ...
        <ul class="children">
                ...
                <li class="">
                    <a href="{{ route('dashboard.matches.index') }}">   <i class="fa fa-dot-circle-o"></i>
                      {{ __('All Matches') }}
                     </a>
                </li>

                <li class="">
                    <a href="{{ route('dashboard.matches.create') }}">   <i class="fa fa-dot-circle-o"></i>
                      {{ __("Add New Matche") }}
                     </a>
                </li>
