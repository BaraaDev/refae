            ...
            <div class="tab-pane active" id="seo_1">
                ...
                @if(is_default_lang())
                    <div class="form-group form-group-image">
                        ...
                        {!! \App\Helpers\FileHelper::fieldUpload('seo_image', $meta_seo['seo_image'] ?? "" ) !!}
                    </div>
                @endif
            </div>
            <div class="tab-pane" id="seo_2">
                ...
                @if(is_default_lang())
                    <div class="form-group form-group-image">
                        ...
                        {!! \App\Helpers\FileHelper::fieldUpload('seo_share[facebook][image]',$seo_share['facebook']['image'] ?? "" ) !!}
                    </div>
                @endif
            </div>
            <div class="tab-pane" id="seo_3">
                ...
                @if(is_default_lang())
                    <div class="form-group form-group-image">
                        ...
                        {!! \App\Helpers\FileHelper::fieldUpload('seo_share[twitter][image]', $seo_share['twitter']['image'] ?? "" ) !!}
                    </div>
                @endif
            </div>
        </div>
