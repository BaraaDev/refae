		    ...
		    <nav>
                ...
                <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
					<li class="active depth-0"><a target="" href="/">Home</a>
                        ...
                        <li class="depth-0"><a href="{{ url('http://localhost:8000/property?property_type=1') }}" href="/">Buy</a>
                        <li class="depth-0"><a href="{{ url('http://localhost:8000/property?property_type=2') }}" href="/">Rent</a>
                        <li class="depth-0"><a href="">Lands</a>
                        <li class="depth-0"><a href="{{ route('agencies.search') }}">Agencies</a>
                        <li class="depth-0"><a href="{{ route('contact.index') }}">Contact Us</a>
					...
					@if(!Auth::check() or Auth::user()->hasPermissionTo('dashboard_agent_access'))
						  <li class="list-inline-item add_listing">
                            <a href="{{route("vendor.dashboard")}}"><span class="flaticon-plus"></span>
                                <span class="dn-lg"> {{ __('Create Listing') }}</span></a></li>
					@endif
                </ul>
		    </nav>
		</div>
