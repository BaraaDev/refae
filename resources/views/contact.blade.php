        ...
        <div class="container">
            <div class="page-title-content">
                ...
                <ul>
                    ...
                    <li class="item"><a href="#"><i class='bx bx-chevrons-right'></i>Contact</a></li>
                </ul>
            </div>
        </div>
        <div class="bg-image">
                    ...
                    <div class="col-lg-5">
                        <div class="content pt-100 pb-70 ">
                            <div class="info-content">
                                ...
                                <div class="content-list">
                                    <i class='bx bx-at'></i>
                                    <h6>Email: <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="630902160d17230a0d050c4d000c0e">[email&#160;protected]</a></h6>
                                </div>
                            </div>
                            <div class="info-content">
                                ...
                                <div class="content-list">
                                    <i class='bx bx-at'></i>
                                    <h6>Email: <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d3b9b2a6bda793babdb5bcfdb0bcbe">[email&#160;protected]</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
